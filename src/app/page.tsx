...
export default function Home() {
  ...
  const processSearch = (slangQuery: string) => {
    if(slangQuery.length > 0){
      getWord(slangQuery).then((wordRes) => {
